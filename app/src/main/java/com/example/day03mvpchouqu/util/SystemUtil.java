...
public class SystemUtil {
    ...
    public static int dp2px(float dpValue) {
        final float scale = BaseApp.baseApp.getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        float scaledDensity = BaseApp.baseApp.getResources().getDisplayMetrics().scaledDensity;
